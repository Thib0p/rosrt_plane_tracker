...
// global functions 
extern "C" void
add_apollo_test_task( void );

// local functions
static int  init_apollo_test_task(void);
static int  run_apollo_test_task(void);
static int  change_apollo_test_task(void);

/*****************************************************************************
******************************************************************************
Function Name	: add_apollo_test_task
Date		: Feb 2015
Remarks:
...
add_apollo_test_task( void )
{
  ...
  addTask("apollo test task", init_apollo_test_task, 
	  run_apollo_test_task, change_apollo_test_task);

}    

/*****************************************************************************
******************************************************************************
  Function Name	: init_apollo_test_task
  Date		: Dec. 1997
...
/*****************************************************************************
******************************************************************************
  Function Name	: run_apollo_test_task
  Date		: Dec. 1997
...
/*****************************************************************************
******************************************************************************
  Function Name	: change_apollo_test_task
  Date		: Dec. 1997
